...
var Map = function Map() {
  ...
  _defineProperty(this, "create", function (params) {
    return new Promise(function (resolve, reject) {
      ...
      _this.map = new _Map["default"](_objectSpread(_objectSpread({}, rest), {}, {
        layers: layers || _this.getDefaultBaseLayers()
      }));

      _this.createLayer(LAYER_TYPE.VECTOR, null, {
        ...
        _this.addLayer(drawing.layer);

        _this.addInteraction(drawing.interaction);

        _this.addInteraction(editing);

        _this.addInteraction(selection);
  ...
  _defineProperty(this, "parseGeoJSONFeature", function (f, customOptions) {
    return new Promise(function (resolve, reject) {
      if (!_this.map || !f) {
        reject();
      }
  ...
  _defineProperty(this, "parseWKTFeature", function (f, customOptions) {
    return new Promise(function (resolve, reject) {
      if (!_this.map || !f) {
        reject();
      }
  ...
  _defineProperty(this, "parseWKTFeatures", function (features) {
    return new Promise(function (resolve, reject) {
      if (!_this.map || !features) {
        reject();
      }

      var collection = new _Collection["default"]();
      features.forEach(function (feature) {
        collection.push(_this.parseWKTFeature(feature));
      });
      resolve(collection);
    });
  });
  ...
  _defineProperty(this, "addGeoJSONFeature", function (layer, feature, customOptions) {
    return new Promise(function (resolve, reject) {
      ...
      _this.parseGeoJSONFeature(feature, customOptions).then(function (parsedFeature) {
  ...
  _defineProperty(this, "addWKTFeature", function (layer, feature, customOptions) {
    return new Promise(function (resolve, reject) {
      if (!_this.map || !layer || !feature) {
        reject();
      }
      ...
      _this.parseWKTFeature(feature, customOptions).then(function (parsedFeature) {
        source.addFeature(parsedFeature);
        resolve(source);
      });
    });
  ...
  _defineProperty(this, "addWKTFeatures", function (layer, features) {
    return new Promise(function (resolve, reject) {
      if (!_this.map || !layer || !features) {
        reject();
      }
      ...
      _this.parseWKTFeatures(features).then(function (parsedFeatures) {
